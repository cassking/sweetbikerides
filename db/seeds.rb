...
c7= Comment.create!(user_id:u4.id, route_review_id:rr2.id, body:"eason. This splendid ride offers somewhat of a recap of the season. It traverses portions of many other rides, including Pioneer Century, Tour de Cure, Portland Century and CF: Cycle for Life as it snakes through Washington County into wine country and across the Canby Ferry. I will be riding this in two weeks")
...
c10= Comment.create!(user_id:u4.id, route_review_id:rr3.id, body:"I will be riding this in eason. This splendid ride offers somewhat of a recap of the season. It traverses portions of many other rides, including Pioneer Century, Tour de Cure, Portland Century and CF: Cycle for Life as it snakes through Washington County into wine country and across the Canby Ferry.two weeks")
c11= Comment.create!(user_id:u2.id, route_review_id:rr3.id, body:"great eason. This splendid ride offers somewhat of a recap of the season. It traverses portions of many other rides, including Pioneer Century, Tour de Cure, Portland Century and CF: Cycle for Life as it snakes through Washington County into wine country and across the Canby Ferry.fun")
c12= Comment.create!(user_id:u3.id, route_review_id:rr3.id, body:"eason. This splendid ride offers somewhat of a recap of the season. It traverses portions of many other rides, including Pioneer Century, Tour de Cure, Portland Century and CF: Cycle for Life as it snakes through Washington County into wine country and across the Canby Ferry.super fun")
